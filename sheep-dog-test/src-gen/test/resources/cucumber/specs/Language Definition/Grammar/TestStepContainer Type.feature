@sheep-dog-test
Feature: TestStepContainer Type
  ...
  Scenario: Concrete Types
    ...
    Given The spec-prj project src/test/resources/asciidoc/specs/ProcessGrammarType.asciidoc file TestStepContainer type is as follows
     Then The spec-prj project src/test/resources/asciidoc/specs/ProcessGrammarType.asciidoc file TestStepContainer type concrete types will be as follows
          | Type      |
          | TestCase  |
          | TestSetup |
