...
Feature: Grammar TestSuite
  ...
  Scenario: Assignments
    ...
    Given The spec-prj project src/test/resources/asciidoc/specs/ProcessGrammar.asciidoc file TestSuite type is as follows
     Then The spec-prj project src/test/resources/asciidoc/specs/ProcessGrammar.asciidoc file TestSuite type assignments will be as follows
  ...
  Scenario Outline: Derived Attributes
    ...
    Given The spec-prj project src/test/resources/asciidoc/specs/ProcessGrammar.asciidoc file TestSuite type is created as follows
          | Full Name   |
          | <Full Name> |
     Then The spec-prj project src/test/resources/asciidoc/specs/ProcessGrammar.asciidoc file TestSuite type derived attributes will be as follows
          | Name   |
          | <Name> |
