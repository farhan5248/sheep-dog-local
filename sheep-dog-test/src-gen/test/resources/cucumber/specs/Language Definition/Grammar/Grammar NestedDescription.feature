@sheep-dog-test
Feature: Grammar NestedDescription
  ...
  Scenario: Assignments
    ...
    Given The spec-prj project src/test/resources/asciidoc/specs/ProcessGrammar.asciidoc file NestedDescription type is as follows
     Then The spec-prj project src/test/resources/asciidoc/specs/ProcessGrammar.asciidoc file NestedDescription type assignments will be as follows
