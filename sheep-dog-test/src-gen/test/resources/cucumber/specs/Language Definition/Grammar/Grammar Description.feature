...
Feature: Grammar Description
  ...
  Scenario: Assignments
    ...
    Given The spec-prj project src/test/resources/asciidoc/specs/ProcessGrammar.asciidoc file Description type is as follows
     Then The spec-prj project src/test/resources/asciidoc/specs/ProcessGrammar.asciidoc file Description type assignments will be as follows
