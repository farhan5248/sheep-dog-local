...
Feature: Code Generation for Workspace Issues
    ...
    Given The spec-prj project src/test/resources/asciidoc/specs/ProcessIssues.asciidoc file Model/TestSuiteList/1/TestStepContainerList/1/TestStepList node is created as follows
     ...
     Then The spec-prj project src/test/resources/asciidoc/stepdefs/daily batchjob/Input file.asciidoc file Model/StepObjectList/1 node will be created as follows
      ...
      And The spec-prj project src/test/resources/asciidoc/stepdefs/daily batchjob/Input file.asciidoc file Model/StepObjectList/1/StepDefinitionList/1/StepParametersList node will be created as follows
          ...
          | E1, E2, E3           |
          | N1, N2               |
      And The spec-prj project src/test/resources/asciidoc/stepdefs/daily batchjob/Input file.asciidoc file Model/StepObjectList/1/StepDefinitionList/1/StepParametersList/2/Table/RowList/1/CellList node will be created as follows
          | Cell Name |
          | N1        |
          | N2        |
  ...
  Scenario: This object step definition text parameter doesn't exist generation
    ...
    Given The spec-prj project src/test/resources/asciidoc/specs/ProcessIssues.asciidoc file Model/TestSuiteList/1/TestStepContainerList/1/TestStepList node is created as follows
          | Test Step Full Name                             |
          | The daily batchjob Input file is set as follows |
      And The spec-prj project src/test/resources/asciidoc/specs/ProcessIssues.asciidoc file Model/TestSuiteList/1/TestStepContainerList/1/TestStepList/1/Text node is created as follows
          | Text Content |
          | Some text    |
      And The spec-prj project src/test/resources/asciidoc/stepdefs/daily batchjob/Input file.asciidoc file Model/StepObjectList node is created as follows
          | Step Object Full Name             | Step Definition Name |
