...
@ScenarioScoped
public class XtextEditDocumentNodeActionSteps extends TestSteps {

    @Inject
    public XtextEditDocumentNodeActionSteps(EditDocumentNodeAction object) {
        super(object, "xtext", "edit document node");
    }
    ...
    @Given("^The xtext plugin edit document node action is performed to modify TestDocumentList with$")
