...
public class SpecPrjInputFileAsciidocFileSteps extends TestSteps {
    ...
    @Given("^The spec-prj project src/test/resources/asciidoc/stepdefs/daily batchjob/app/Input file.asciidoc file TestDocumentList node is created as follows$")
