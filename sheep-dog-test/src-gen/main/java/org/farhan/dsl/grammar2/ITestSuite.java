 ...
 * </p>
 * <ul>
 *   <li>{@link org.farhan.dsl.grammar2.ITestSuite#getTestStepContainerList <em>Test Step Container List</em>}</li>
 * </ul>
 *
 * @see org.farhan.dsl.grammar2.ISheepDogPackage#getTestSuite()
 * @model
 * @generated
 */
public interface ITestSuite extends ITestDocument
{
	 ...
	 * The list contents are of type {@link org.farhan.dsl.grammar2.ITestStepContainer}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Test Step Container List</em>' containment reference list.
	 * @see org.farhan.dsl.grammar2.ISheepDogPackage#getTestSuite_TestStepContainerList()
