...
public class TestSuiteIssueResolver {
	...
	public static ArrayList<SheepDogIssueProposal> proposeName(ITestSuite theTestSuite) {
		// TODO shouldn't this take a TestSuite as a parameter
		logger.debug("Entering proposeName for test suite: {}", theTestSuite != null ? theTestSuite.getName() : "null");
		...
		proposal.setValue(theTestSuite.getName().substring(0, 1).toUpperCase());
