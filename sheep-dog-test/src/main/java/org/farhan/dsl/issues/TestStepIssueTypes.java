...
public enum TestStepIssueTypes {
	...
	TEST_STEP_NAME_DETAILS_ONLY("TEST_STEP_NAME_DETAILS_ONLY",
	...
	TEST_STEP_NAME_OBJECT_ONLY("TEST_STEP_NAME_OBJECT_ONLY",
	...
	TEST_STEP_NAME_STATE_ONLY("TEST_STEP_NAME_STATE_ONLY", "After specifying the object, a predicate is specified."
	...
	TEST_STEP_NAME_TIME_ONLY("TEST_STEP_NAME_TIME_ONLY",
			"After specifying the object, a predicate is specified."
	...
	TEST_STEP_NAME_COMPONENT_WORKSPACE("TEST_STEP_NAME_COMPONENT_WORKSPACE", "The first step must have a component"),

	TEST_STEP_NAME_STEP_OBJECT_WORKSPACE("TEST_STEP_NAME_STEP_OBJECT_WORKSPACE",
			"The step object file doesn't exist for the component"),

	TEST_STEP_NAME_STEP_DEFINITION_WORKSPACE("TEST_STEP_NAME_STEP_DEFINITION_WORKSPACE",
