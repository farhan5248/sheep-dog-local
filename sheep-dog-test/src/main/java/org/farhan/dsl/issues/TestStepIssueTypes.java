...
public enum TestStepIssueTypes {
	...
	TEST_STEP_NAME_PREDICATE_DETAILS_ONLY("TEST_STEP_NAME_PREDICATE_DETAILS_ONLY",
	...
	TEST_STEP_NAME_PREDICATE_STATE_ONLY("TEST_STEP_NAME_PREDICATE_STATE_ONLY", "After specifying the object, a predicate is specified."
	...
	TEST_STEP_NAME_PREDICATE_TIME_ONLY("TEST_STEP_NAME_PREDICATE_TIME_ONLY",
			"After specifying the object, a predicate is specified."
	...
	TEST_STEP_NAME_OBJECT_WORKSPACE("TEST_STEP_NAME_OBJECT_WORKSPACE",
			"The step object file doesn't exist for the component"),

	TEST_STEP_NAME_PREDICATE_WORKSPACE("TEST_STEP_NAME_PREDICATE_WORKSPACE",
