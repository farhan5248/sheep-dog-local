...
/**
 * Interface representing a raw text block (docstring) in a test step.
 * Text blocks are delimited by '----' markers and contain raw content.
 */
public interface IText {
	...
	/**
	 * Sets the parent test step for this text.
