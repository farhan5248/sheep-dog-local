...
public class LanguageHelper {
	...
	public static Object[] getAlternateObjects(ILanguageAccess la) throws Exception {
		...
		try {
			...
			logger.error("Failed in getAlternateObjects for step '{}': {}", la != null ? la.getStepName() : "null", e.getMessage(), e);
			throw e;
		}
	}
	...
	public static void generate(ILanguageAccess la, Map<Object, Object> options) throws Exception {
		...
		try {
			...
			logger.error("Failed in generate for step '{}': {}", la != null ? la.getStepName() : "null", e.getMessage(), e);
			throw e;
		}
	}
	...
	public static String getStepObjectQualifiedName(ILanguageAccess la) {
		...
		try {
			...
			logger.error("Failed in getStepObjectQualifiedName for step '{}': {}", la != null ? la.getStepName() : "null", e.getMessage(), e);
			throw e;
		}
	}
	...
	public static TreeMap<String, Proposal> proposeStepParameters(ILanguageAccess la) throws Exception {
		...
		try {
			...
			logger.error("Failed in proposeStepParameters for step '{}': {}", la != null ? la.getStepName() : "null", e.getMessage(), e);
			throw e;
		}
	}
	...
	public static TreeMap<String, Proposal> proposeTestStepName(ILanguageAccess la) throws Exception {
		...
		try {
			...
			logger.error("Failed in proposeTestStepName for step '{}': {}", la != null ? la.getStepName() : "null", e.getMessage(), e);
			throw e;
		}
	}
	...
	public static String validateError(ILanguageAccess la) throws Exception {
		...
		try {
			...
			logger.error("Failed in validateError for step '{}': {}", la != null ? la.getStepName() : "null", e.getMessage(), e);
			throw e;
		}
	}
	...
	public static String validateWarning(ILanguageAccess la) throws Exception {
		...
		try {
			...
			logger.error("Failed in validateWarning for step '{}': {}", la != null ? la.getStepName() : "null", e.getMessage(), e);
			throw e;
		}
	}
