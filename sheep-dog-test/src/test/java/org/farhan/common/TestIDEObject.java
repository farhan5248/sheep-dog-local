...
public class TestIDEObject extends TestObject {
    ...
    public void addCellWithName(String name) {
        if (focus instanceof ICell) {
    ...
    public void addTestCaseWithName(String testStepContainerName) {
    ...
    public void addTestStepWithFullName(String stepName) {
    ...
    public void createStepDependencies(String part) {
        super.createStepDependencies(part);
        selectedNode = part;
        ...
        while (i < parts.length) {
            ...
            if (elementType.equals("Table")) {
                ITable table = ((ITestStep) current).getTable();
                if (table == null) {
