...
3. **{Assignment}** - Named assignments within grammar rules
   - Values: `(Name|Description|NestedDescription|LineList|StepDefinitionList|StepParameterList|Table|TestStepContainerList|TestStepList|TestDataList|StepObjectName|StepDefinitionName|Text|RowList|CellList|TestDocumentList|TestSuiteList)`
