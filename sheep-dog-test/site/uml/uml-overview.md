...
3. **{Assignment}** - Named assignments within grammar rules
   - Values: `(Content|Name|Description|FullName|Parent|LineList|StepDefinitionList|StepParameterList|StepParameters|Table|TestStepContainerList|TestStepList|TestDataList|StepObjectName|StepDefinitionName|Text|RowList|CellList|CellList|TestDocumentList)`
