 ...
 * </p>
 * <ul>
 *   <li>{@link org.farhan.dsl.sheepdog.sheepDog.impl.DescriptionImpl#getLineList <em>Line List</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DescriptionImpl extends MinimalEObjectImpl.Container implements Description
{
  ...
  {
    return SheepDogPackage.Literals.DESCRIPTION;
  }
  ...
  public EList<Line> getLineList()
  {
    if (lineList == null)
    {
      lineList = new EObjectContainmentEList<Line>(Line.class, this, SheepDogPackage.DESCRIPTION__LINE_LIST);
    }
    return lineList;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case SheepDogPackage.DESCRIPTION__LINE_LIST:
