...
public class InternalSheepDogLexer extends Lexer {
    ...
    public final void mT__35() throws RecognitionException {
        try {
            int _type = T__35;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalSheepDog.g:37:7: ( 'popup' )
            // InternalSheepDog.g:37:9: 'popup'
            {
            match("popup"); 
    ...
    public final void mT__36() throws RecognitionException {
        try {
            int _type = T__36;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalSheepDog.g:38:7: ( 'annotation' )
            // InternalSheepDog.g:38:9: 'annotation'
            {
            match("annotation"); 
    ...
    public final void mT__37() throws RecognitionException {
        try {
            int _type = T__37;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalSheepDog.g:39:7: ( 'hover' )
            // InternalSheepDog.g:39:9: 'hover'
            {
            match("hover"); 
    ...
    public final void mT__38() throws RecognitionException {
        try {
            int _type = T__38;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalSheepDog.g:40:7: ( 'tooltip' )
            // InternalSheepDog.g:40:9: 'tooltip'
            {
            match("tooltip"); 
    ...
    public final void mRULE_WS() throws RecognitionException {
        try {
            int _type = RULE_WS;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalSheepDog.g:1730:9: ( ( ' ' | '\\t' | '\\r' )+ )
            // InternalSheepDog.g:1730:11: ( ' ' | '\\t' | '\\r' )+
            {
            // InternalSheepDog.g:1730:11: ( ' ' | '\\t' | '\\r' )+
            int cnt1=0;
            loop1:
    ...
    public final void mRULE_SL_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalSheepDog.g:1732:17: ( '#' (~ ( '\\n' ) )* RULE_EOL )
            // InternalSheepDog.g:1732:19: '#' (~ ( '\\n' ) )* RULE_EOL
            {
            match('#'); 
            // InternalSheepDog.g:1732:23: (~ ( '\\n' ) )*
            loop2:
            do {
                int alt2=2;
    ...
    public final void mRULE_EOL() throws RecognitionException {
        try {
            int _type = RULE_EOL;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalSheepDog.g:1734:10: ( ( '\\n' )+ )
            // InternalSheepDog.g:1734:12: ( '\\n' )+
            {
            // InternalSheepDog.g:1734:12: ( '\\n' )+
            int cnt3=0;
            loop3:
    ...
    public final void mRULE_TEXT_BLOCK() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalSheepDog.g:1736:17: ( '----' '\\n' ( . )+ '\\n' '----' )
            // InternalSheepDog.g:1736:19: '----' '\\n' ( . )+ '\\n' '----'
            {
            match("----"); 

            match('\n'); 
            // InternalSheepDog.g:1736:31: ( . )+
            int cnt4=0;
            loop4:
            do {
                int alt4=2;
    ...
    public final void mRULE_WORD() throws RecognitionException {
        try {
            int _type = RULE_WORD;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalSheepDog.g:1738:11: ( (~ ( ( ' ' | '\\t' | '\\r' | '\\n' ) ) )+ )
            // InternalSheepDog.g:1738:13: (~ ( ( ' ' | '\\t' | '\\r' | '\\n' ) ) )+
            {
            // InternalSheepDog.g:1738:13: (~ ( ( ' ' | '\\t' | '\\r' | '\\n' ) ) )+
            int cnt5=0;
            loop5:
