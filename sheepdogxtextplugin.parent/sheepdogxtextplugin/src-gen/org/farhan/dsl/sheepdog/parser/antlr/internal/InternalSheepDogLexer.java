...
public class InternalSheepDogLexer extends Lexer {
    ...
    public final void mRULE_STEP_OBJECT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalSheepDog.g:1565:18: ( 'The' ( ' ' ( RULE_ID )+ ( ' application' | ' service' | ' plugin' | ' batchjob' | ' project' ) ',' )? ' ' ( RULE_ID )+ ( ( ' file' | ' page' | ' response' | ' dialog' | ' directory' ) | ( ' request' | ' goal' | ' job' | ' action' ) ) )
            // InternalSheepDog.g:1565:20: 'The' ( ' ' ( RULE_ID )+ ( ' application' | ' service' | ' plugin' | ' batchjob' | ' project' ) ',' )? ' ' ( RULE_ID )+ ( ( ' file' | ' page' | ' response' | ' dialog' | ' directory' ) | ( ' request' | ' goal' | ' job' | ' action' ) )
            {
            match("The"); 

            // InternalSheepDog.g:1565:26: ( ' ' ( RULE_ID )+ ( ' application' | ' service' | ' plugin' | ' batchjob' | ' project' ) ',' )?
            int alt3=2;
            alt3 = dfa3.predict(input);
            switch (alt3) {
                case 1 :
                    // InternalSheepDog.g:1565:27: ' ' ( RULE_ID )+ ( ' application' | ' service' | ' plugin' | ' batchjob' | ' project' ) ','
                    {
                    match(' '); 
                    // InternalSheepDog.g:1565:31: ( RULE_ID )+
                    int cnt1=0;
                    loop1:
                    do {
                        int alt1=2;
                    ...
                    // InternalSheepDog.g:1565:40: ( ' application' | ' service' | ' plugin' | ' batchjob' | ' project' )
                    int alt2=5;
                    ...
                    switch (alt2) {
                        case 1 :
                            // InternalSheepDog.g:1565:41: ' application'
                            {
                            match(" application"); 
                            ...
                            break;
                        case 2 :
                            // InternalSheepDog.g:1565:56: ' service'
                            {
                            match(" service"); 
                            ...
                            break;
                        case 3 :
                            // InternalSheepDog.g:1565:67: ' plugin'
                            {
                            match(" plugin"); 
                            ...
                            break;
                        case 4 :
                            // InternalSheepDog.g:1565:77: ' batchjob'
                            {
                            match(" batchjob"); 
                            ...
                            break;
                        case 5 :
                            // InternalSheepDog.g:1565:89: ' project'
                            {
                            match(" project"); 
            ...
            match(' '); 
            // InternalSheepDog.g:1565:111: ( RULE_ID )+
            int cnt4=0;
            loop4:
            do {
                int alt4=2;
            ...
            // InternalSheepDog.g:1565:120: ( ( ' file' | ' page' | ' response' | ' dialog' | ' directory' ) | ( ' request' | ' goal' | ' job' | ' action' ) )
            int alt7=2;
            ...
            switch (alt7) {
                case 1 :
                    // InternalSheepDog.g:1565:121: ( ' file' | ' page' | ' response' | ' dialog' | ' directory' )
                    {
                    // InternalSheepDog.g:1565:121: ( ' file' | ' page' | ' response' | ' dialog' | ' directory' )
                    int alt5=5;
                    ...
                    switch (alt5) {
                        case 1 :
                            // InternalSheepDog.g:1565:122: ' file'
                            {
                            match(" file"); 
                            ...
                            break;
                        case 2 :
                            // InternalSheepDog.g:1565:130: ' page'
                            {
                            match(" page"); 
                            ...
                            break;
                        case 3 :
                            // InternalSheepDog.g:1565:138: ' response'
                            {
                            match(" response"); 
                            ...
                            break;
                        case 4 :
                            // InternalSheepDog.g:1565:150: ' dialog'
                            {
                            match(" dialog"); 
                            ...
                            break;
                        case 5 :
                            // InternalSheepDog.g:1565:160: ' directory'
                            {
                            match(" directory"); 
                    ...
                    break;
                case 2 :
                    // InternalSheepDog.g:1565:174: ( ' request' | ' goal' | ' job' | ' action' )
                    {
                    // InternalSheepDog.g:1565:174: ( ' request' | ' goal' | ' job' | ' action' )
                    int alt6=4;
                    ...
                    switch (alt6) {
                        case 1 :
                            // InternalSheepDog.g:1565:175: ' request'
                            {
                            match(" request"); 
                            ...
                            break;
                        case 2 :
                            // InternalSheepDog.g:1565:186: ' goal'
                            {
                            match(" goal"); 
                            ...
                            break;
                        case 3 :
                            // InternalSheepDog.g:1565:194: ' job'
                            {
                            match(" job"); 
                            ...
                            break;
                        case 4 :
                            // InternalSheepDog.g:1565:201: ' action'
                            {
                            match(" action"); 
    ...
    public final void mRULE_STEP_DEFINITION() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalSheepDog.g:1567:22: ( ( ( RULE_ID )+ ' ' ( 'section' | 'fragment' | 'table' | 'snippet' | 'list' ) )? ' ' ( 'is' | 'isn\\'t' | 'will be' | 'won\\'t be' ) ' ' ( RULE_ID )+ ( ' ' ( 'with' | 'as follows' ) )? ( ' ' ( 'at' | 'before' | 'after' | 'in' | 'on' ) ' ' ( RULE_ID )+ )? )
            // InternalSheepDog.g:1567:24: ( ( RULE_ID )+ ' ' ( 'section' | 'fragment' | 'table' | 'snippet' | 'list' ) )? ' ' ( 'is' | 'isn\\'t' | 'will be' | 'won\\'t be' ) ' ' ( RULE_ID )+ ( ' ' ( 'with' | 'as follows' ) )? ( ' ' ( 'at' | 'before' | 'after' | 'in' | 'on' ) ' ' ( RULE_ID )+ )?
            {
            // InternalSheepDog.g:1567:24: ( ( RULE_ID )+ ' ' ( 'section' | 'fragment' | 'table' | 'snippet' | 'list' ) )?
            int alt10=2;
            ...
            switch (alt10) {
                case 1 :
                    // InternalSheepDog.g:1567:25: ( RULE_ID )+ ' ' ( 'section' | 'fragment' | 'table' | 'snippet' | 'list' )
                    {
                    // InternalSheepDog.g:1567:25: ( RULE_ID )+
                    int cnt8=0;
                    loop8:
                    do {
                        int alt8=2;
                    ...
                    match(' '); 
                    // InternalSheepDog.g:1567:38: ( 'section' | 'fragment' | 'table' | 'snippet' | 'list' )
                    int alt9=5;
                    switch ( input.LA(1) ) {
                    case 's':
                        {
                    ...
                    switch (alt9) {
                        case 1 :
                            // InternalSheepDog.g:1567:39: 'section'
                            {
                            match("section"); 
                            ...
                            break;
                        case 2 :
                            // InternalSheepDog.g:1567:49: 'fragment'
                            {
                            match("fragment"); 
                            ...
                            break;
                        case 3 :
                            // InternalSheepDog.g:1567:60: 'table'
                            {
                            match("table"); 
                            ...
                            break;
                        case 4 :
                            // InternalSheepDog.g:1567:68: 'snippet'
                            {
                            match("snippet"); 
                            ...
                            break;
                        case 5 :
                            // InternalSheepDog.g:1567:78: 'list'
                            {
                            match("list"); 
            ...
            match(' '); 
            // InternalSheepDog.g:1567:92: ( 'is' | 'isn\\'t' | 'will be' | 'won\\'t be' )
            int alt11=4;
            ...
            switch (alt11) {
                case 1 :
                    ...
                    break;
                case 2 :
                    // InternalSheepDog.g:1567:98: 'isn\\'t'
                    {
                    match("isn't"); 
                    ...
                    break;
                case 3 :
                    // InternalSheepDog.g:1567:107: 'will be'
                    {
                    match("will be"); 
                    ...
                    break;
                case 4 :
                    // InternalSheepDog.g:1567:117: 'won\\'t be'
                    {
                    match("won't be"); 
            ...
            match(' '); 
            // InternalSheepDog.g:1567:134: ( RULE_ID )+
            int cnt12=0;
            loop12:
            do {
                int alt12=2;
            ...
            // InternalSheepDog.g:1567:143: ( ' ' ( 'with' | 'as follows' ) )?
            int alt14=2;
            ...
            switch (alt14) {
                case 1 :
                    // InternalSheepDog.g:1567:144: ' ' ( 'with' | 'as follows' )
                    {
                    match(' '); 
                    // InternalSheepDog.g:1567:148: ( 'with' | 'as follows' )
                    int alt13=2;
                    ...
                    switch (alt13) {
                        case 1 :
                            // InternalSheepDog.g:1567:149: 'with'
                            {
                            match("with"); 
                            ...
                            break;
                        case 2 :
                            // InternalSheepDog.g:1567:156: 'as follows'
                            {
                            match("as follows"); 
            ...
            // InternalSheepDog.g:1567:172: ( ' ' ( 'at' | 'before' | 'after' | 'in' | 'on' ) ' ' ( RULE_ID )+ )?
            int alt17=2;
            ...
            switch (alt17) {
                case 1 :
                    // InternalSheepDog.g:1567:173: ' ' ( 'at' | 'before' | 'after' | 'in' | 'on' ) ' ' ( RULE_ID )+
                    {
                    match(' '); 
                    // InternalSheepDog.g:1567:177: ( 'at' | 'before' | 'after' | 'in' | 'on' )
                    int alt15=5;
                    switch ( input.LA(1) ) {
                    case 'a':
                        {
                    ...
                    switch (alt15) {
                        case 1 :
                            // InternalSheepDog.g:1567:178: 'at'
                            {
                            match("at"); 
                            ...
                            break;
                        case 2 :
                            // InternalSheepDog.g:1567:183: 'before'
                            {
                            match("before"); 
                            ...
                            break;
                        case 3 :
                            // InternalSheepDog.g:1567:192: 'after'
                            {
                            match("after"); 
                            ...
                            break;
                        case 4 :
                            // InternalSheepDog.g:1567:200: 'in'
                            {
                            match("in"); 
                            ...
                            break;
                        case 5 :
                            // InternalSheepDog.g:1567:205: 'on'
                            {
                            match("on"); 
                    ...
                    match(' '); 
                    // InternalSheepDog.g:1567:215: ( RULE_ID )+
                    int cnt16=0;
                    loop16:
                    do {
                        int alt16=2;
    ...
    public final void mRULE_ID() throws RecognitionException {
        try {
            // InternalSheepDog.g:1569:18: (~ ( ( ' ' | '\\t' | '\\r' | '\\n' | '|' | '#' | ',' ) ) )
            // InternalSheepDog.g:1569:20: ~ ( ( ' ' | '\\t' | '\\r' | '\\n' | '|' | '#' | ',' ) )
            {
    ...
    public final void mRULE_WORD() throws RecognitionException {
        try {
            int _type = RULE_WORD;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalSheepDog.g:1571:11: (~ ( ( ' ' | '\\t' | '\\r' | '\\n' | '|' | '#' ) ) (~ ( ( ' ' | '\\t' | '\\r' | '\\n' ) ) )* )
            // InternalSheepDog.g:1571:13: ~ ( ( ' ' | '\\t' | '\\r' | '\\n' | '|' | '#' ) ) (~ ( ( ' ' | '\\t' | '\\r' | '\\n' ) ) )*
            {
    ...
    public final void mRULE_WS() throws RecognitionException {
        try {
            int _type = RULE_WS;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalSheepDog.g:1573:9: ( ( ' ' | '\\t' | '\\r' )+ )
            // InternalSheepDog.g:1573:11: ( ' ' | '\\t' | '\\r' )+
            {
            // InternalSheepDog.g:1573:11: ( ' ' | '\\t' | '\\r' )+
            int cnt19=0;
            loop19:
    ...
    public final void mRULE_SL_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalSheepDog.g:1575:17: ( '#' (~ ( '\\n' ) )* RULE_EOL )
            // InternalSheepDog.g:1575:19: '#' (~ ( '\\n' ) )* RULE_EOL
            {
            match('#'); 
            // InternalSheepDog.g:1575:23: (~ ( '\\n' ) )*
            loop20:
            do {
                int alt20=2;
    ...
    public final void mRULE_EOL() throws RecognitionException {
        try {
            int _type = RULE_EOL;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalSheepDog.g:1577:10: ( ( '\\n' )+ )
            // InternalSheepDog.g:1577:12: ( '\\n' )+
            {
            // InternalSheepDog.g:1577:12: ( '\\n' )+
            int cnt21=0;
            loop21:
    ...
    public final void mRULE_RAWTEXT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalSheepDog.g:1579:14: ( '----' '\\n' ( . )+ '\\n' '----' )
            // InternalSheepDog.g:1579:16: '----' '\\n' ( . )+ '\\n' '----'
            {
            match("----"); 

            match('\n'); 
            // InternalSheepDog.g:1579:28: ( . )+
            int cnt22=0;
            loop22:
            do {
                int alt22=2;
    ...
    class DFA3 extends DFA {
        ...
        public String getDescription() {
            return "1565:26: ( ' ' ( RULE_ID )+ ( ' application' | ' service' | ' plugin' | ' batchjob' | ' project' ) ',' )?";
        }
