...
public class SheepDogParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, SheepDogGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getGivenAccess().getObjectAssignment_2(), "rule__Given__ObjectAssignment_2");
			builder.put(grammarAccess.getGivenAccess().getPredicateAssignment_3(), "rule__Given__PredicateAssignment_3");
			...
			builder.put(grammarAccess.getWhenAccess().getObjectAssignment_2(), "rule__When__ObjectAssignment_2");
			builder.put(grammarAccess.getWhenAccess().getPredicateAssignment_3(), "rule__When__PredicateAssignment_3");
			...
			builder.put(grammarAccess.getThenAccess().getObjectAssignment_2(), "rule__Then__ObjectAssignment_2");
			builder.put(grammarAccess.getThenAccess().getPredicateAssignment_3(), "rule__Then__PredicateAssignment_3");
			...
			builder.put(grammarAccess.getAndAccess().getObjectAssignment_2(), "rule__And__ObjectAssignment_2");
			builder.put(grammarAccess.getAndAccess().getPredicateAssignment_3(), "rule__And__PredicateAssignment_3");
